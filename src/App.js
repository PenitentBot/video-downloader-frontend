            ...
            <div style={styles.container}>
              ...
              <div style={styles.infoSection}>
                <div style={styles.infoCard}>
                  ...
                  <h3>Easy to Use</h3>
                  <p>Paste URL and download instantly in seconds</p>
                </div>
                <div style={styles.infoCard}>
                  <div style={styles.iconBig}>🎥</div>
                  <h3>Multiple Formats</h3>
                  <p>Download as MP4, MP3, 480p, 720p, 1080p</p>
                </div>
                <div style={styles.infoCard}>
                  <div style={styles.iconBig}>⚡</div>
                  <h3>1000+ Sites</h3>
                  <p>Works with YouTube, TikTok, Instagram & more</p>
                </div>
              </div>
              ...
              <div style={styles.featuresSection}>
                ...
                <div style={styles.featuresGrid}>
                  ...
                  <div style={styles.featureBox}>
                    <span style={styles.featureEmoji}>⭐</span>
                    <h4>HD Quality</h4>
                    <p>Download in 480p, 720p, or 1080p</p>
                  </div>
                </div>
              </div>
            </div>
